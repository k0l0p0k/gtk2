...
{                                  
    ...
    GtkWidget *button_add, *button_clear, *button_hide_show, *button_close;    
    ...
    gtk_box_pack_start (GTK_BOX (hbox), button_add, FALSE, TRUE, 10);
    gtk_box_pack_start (GTK_BOX (hbox), button_clear, FALSE, TRUE, 3);
    gtk_box_pack_start (GTK_BOX (hbox), button_hide_show, FALSE, TRUE, 10);
	gtk_box_pack_end (GTK_BOX (hbox), button_close, FALSE, TRUE, 10);
